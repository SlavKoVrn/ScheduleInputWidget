...
use slavko\schedule\renderers\TableRenderer;
use slavko\schedule\renderers\RendererInterface;

/**
 * Class TabularInput
 * @package slavko\schedule
 */
class TabularInput extends Widget
{
     ...
     * Defaults to `slavko\schedule\TabularColumn`
     */
    public $columnClass;

    /**
     * @var string the name of renderer class. Defaults to `slavko\schedule\renderers\TableRenderer`.
     * @since 1.4
     */
